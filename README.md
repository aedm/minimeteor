...
MiniMeteor is an effort to simplify Docker image creation for Meteor projects.

## Usage

#### First method: execute a script (Meteor 1.4+)
...
#### Second method: use a Dockerfile (Meteor 1.3+)
